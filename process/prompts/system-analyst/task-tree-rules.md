...
- Existing legacy flat `FEATURE-*` cards may link to `docs/system/feature-specs/<feature-id>-<slug>.md` and sibling `.test-scenarios.md` until the next system-analysis package migration.
