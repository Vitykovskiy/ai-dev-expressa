...
- If assigned a feature-level architecture task, decompose one `FEATURE-*` into review-ready `AR/FE/BE/DO/QA-*` tasks, including separate manual QA and e2e QA tasks for subsequent feature decompositions.
