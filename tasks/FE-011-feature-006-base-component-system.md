...
- Ожидаемый результат для ревью: `Внутри клиентской части apps/backoffice-web появился переиспользуемый слой базовых UI-компонентов в src/components/base, пригодный для переноса layout и экранов меню без смешения с транспортом, маршрутизацией и хранилищами состояния.`
