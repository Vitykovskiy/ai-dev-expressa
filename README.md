...
- `FE-011-base-component-system-context.md` — собранный рабочий контекст для реализации задачи `FE-011` по базовой системе компонентов внутреннего административного контура.
