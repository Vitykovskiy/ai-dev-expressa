...
- Если нужно понять границы системы, внешние роли, Telegram-точки входа, delivery units и зафиксированные несогласованности: `system-context`.
...
- `Expressa v1 Telegram Ordering`
  ...
  - Использовать, если нужно быстро зафиксировать границы продукта, внешних акторов, системную ответственность, delivery units, ограничения и открытые вопросы верхнего уровня.
