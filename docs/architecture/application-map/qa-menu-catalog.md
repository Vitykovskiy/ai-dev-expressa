...
| E2E                      | Browser suite через опубликованный e2e-стенд: administrator создает категорию, товар-напиток с ценами `S/M/L`, группу дополнительных опций, опции и назначает группу на категорию; финальное evidence собирается локальным запуском Playwright.  |
