...
- Описание: `Подготовить локальный и test runtime для `FEATURE-001`: базовый маршрут запуска backend foundation и frontend foundation, минимальные env templates, smoke-check для связки `client -> server` и понятный путь доставки первого vertical slice. Полный delivery-маршрут всего административного спринта, bot entrypoint и остальные контуры `DU-01` в scope этой задачи не входят.`
...
- Дополнительные материалы: `tasks/Sprint-001-administration-foundation.md`, `tasks/FEATURE-001-foundation-runtime-bootstrap.md`, `tasks/AR-002-feature-001-foundation-slicing.md`, `docs/system/system-context/expressa-v1-telegram-ordering.md`, `docs/architecture/du-01-administration.md`, `docs/architecture/stack.md`, `docs/architecture/application-map.md`, `docs/architecture/deployment-map.md`

## Примечания

- Зависимости: `AR-002`
- Минимальный read set: `tasks/Sprint-001-administration-foundation.md`, `tasks/FEATURE-001-foundation-runtime-bootstrap.md`, `tasks/AR-002-feature-001-foundation-slicing.md`, `docs/system/system-context/expressa-v1-telegram-ordering.md`, `docs/architecture/du-01-administration.md`, `docs/architecture/stack.md`, `docs/architecture/application-map.md`, `docs/architecture/deployment-map.md`
- Ожидаемый результат для ревью: `Runtime foundation `FEATURE-001` воспроизводимо поднимается локально или на test-стенде и проходит smoke-check связки `client -> server`.`
- Проверки: `Локальный запуск или эквивалентный runtime для backend foundation и frontend foundation; pipeline validation install/test/build для foundation-среза; smoke-check минимального запроса клиента к серверу.`
