...
| `03` | `done` | `FEATURE-003`: довести browser e2e-покрытие slot settings до полного соответствия required/optional сценариям `FTS-003-001` ... `FTS-003-006`, не трогая manual-only `FTS-003-007` | `QA-E2E-SCENARIOS-context-03-feature-003-slot-settings.md` |
