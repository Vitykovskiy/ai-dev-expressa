...
- Описание: `Нужно переписать визуальный каркас BackofficeLayout по React-референсу, используя базовую систему компонентов из FE-011. Нужно сохранить серверно-управляемую навигацию вкладок, route guards, экран отказа в доступе, bootstrap доступа, восстановление сессии и текущее поведение test-окружения.`
...
- Ожидаемый результат для ревью: `Root layout, мобильная нижняя навигация, планшетная боковая навигация, top bar, состояния блокировки и экран отказа в доступе визуально соответствуют UI-контракту, а доступ по ролям не изменён.`
