...
export interface MenuCatalogClient {
  ...
  updateCategory(menuCategoryId: string, payload: MenuCategoryPayload): Promise<MenuCatalogSnapshot>;
  ...
  updateItem(menuItemId: string, payload: MenuItemPayload): Promise<MenuCatalogSnapshot>;
  ...
  updateOptionGroup(optionGroupId: string, payload: OptionGroupPayload): Promise<MenuCatalogSnapshot>;
...
export class MenuCatalogApi implements MenuCatalogClient {
  ...
  async createCategory(payload: MenuCategoryPayload): Promise<MenuCatalogSnapshot> {
  ...
  async updateCategory(menuCategoryId: string, payload: MenuCategoryPayload): Promise<MenuCatalogSnapshot> {
    return this.request<MenuCatalogSnapshot>(`/backoffice/menu/categories/${menuCategoryId}`, {
      method: "PATCH",
      body: JSON.stringify(payload)
    });
  }
  ...
  async updateItem(menuItemId: string, payload: MenuItemPayload): Promise<MenuCatalogSnapshot> {
    return this.request<MenuCatalogSnapshot>(`/backoffice/menu/items/${menuItemId}`, {
      method: "PATCH",
      body: JSON.stringify(payload)
    });
  }
  ...
  async createOptionGroup(payload: OptionGroupPayload): Promise<MenuCatalogSnapshot> {
  ...
  async updateOptionGroup(optionGroupId: string, payload: OptionGroupPayload): Promise<MenuCatalogSnapshot> {
    return this.request<MenuCatalogSnapshot>(`/backoffice/menu/option-groups/${optionGroupId}`, {
      method: "PATCH",
      body: JSON.stringify(payload)
    });
  }
  ...
  private async request<T>(path: string, init: RequestInit = {}): Promise<T> {
    const response = await (this.options.fetchImpl ?? fetch)(this.resolveUrl(path), {
      ...init,
      headers: {
