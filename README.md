...
- `prompts/qa/prompt.md` — тестирование; валидирует одну назначенную фичу, поддерживает e2e-покрытие, проверяет UI parity для UI-фич и фиксирует воспроизводимые дефекты.
