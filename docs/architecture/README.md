...
- После появления нового runtime-контура в `apps/` или `infra/` проверяйте, что карта отражает фактические workspace scripts и smoke-путь первого working slice.
