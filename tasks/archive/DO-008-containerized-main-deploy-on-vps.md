...
- Задача сохраняет e2e QA как отдельный контур от Deploy Test.
...
- Система не должна смешивать Deploy Test и e2e QA в один обязательный pipeline route.
