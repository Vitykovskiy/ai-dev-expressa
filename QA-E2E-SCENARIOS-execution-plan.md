...
| `02` | `pending` | `FEATURE-002`: довести browser e2e-покрытие menu catalog до полного соответствия required/optional сценариям `FTS-002-001` ... `FTS-002-009`, не трогая manual-only `FTS-002-010`  | `QA-E2E-SCENARIOS-context-02-feature-002-menu-catalog.md`  |
