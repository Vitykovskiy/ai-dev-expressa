...
- Ожидаемый результат для ревью: `Собранная delivery unit DU-03 дает barista рабочий end-to-end контур обработки заказа и связанные уведомления как единый reviewable результат.`
- Проверки: `Собранный результат проходит обязательные проверки child-задач FE/BE/DO и финальный приемочный сценарий barista.`
- Обновление карты приложения: `Обязательно в child-задачах, если меняются каталоги, entrypoints, env/config, notification flow или deployment path.`
