...
- Проверки: `Pipeline-validation для затронутых workflow; test-окружение или локальная дымовая проверка критического сценария FEATURE-001; документированный порядок восстановления для неуспешного развёртывания Telegram-входа administrator.`
