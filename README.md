...
- `docs/architecture/` — архитектурные решения, карта приложения, стандарт архитектуры клиентской части, кодстайл и инструкции по развёртыванию.
...
- `docs/architecture/code-style.md` — единый стандарт кодирования, тестирования и критериев допуска к ревью.
- `docs/architecture/frontend-architecture.md` — обязательный стандарт архитектуры клиентской части на `Vue 3` и `TypeScript`.
...
- Для любой клиентской части на `Vue 3` обязательным является `docs/architecture/frontend-architecture.md`.
...
- При изменении структуры кода, точек входа, интерфейсов между модулями, окружения и конфигурации, способов запуска, тестирования или деплоя нужно обновить:
  - `docs/architecture/frontend-architecture.md`, если меняются обязательная структура Vue-приложений, границы слоев клиентской части или правила размещения кода
