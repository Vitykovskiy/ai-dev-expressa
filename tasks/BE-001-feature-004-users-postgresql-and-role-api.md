...
- Критерии готовности: `Consumer-facing endpoints GET /backoffice/users и PATCH /backoffice/users/{userId}/role реализованы и соответствуют contract; in-memory хранение не является итоговым runtime path для FEATURE-004; success path BootstrapAdministrator, availableRoleAssignments, error mapping и capability guard users воспроизводимы автоматическими проверками`
